...
### 数据存储
- 🗄️ **MySQL** - 长期记忆持久化（用户偏好、历史行程、聊天记录）
...
- 项目描述中提到的MySQL和Redis是**架构设计方案**（面向生产环境）
- 如需切换到MySQL/Redis，需修改 `context/long_term_memory.py` 和 `context/short_term_memory.py`
